...
export const api_v1_hgfhjf_list = () => ({ type: types.API_V1_HGFHJF_LIST })
export const api_v1_hgfhjf_listSucceeded = response => ({
  type: types.API_V1_HGFHJF_LIST_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_listFailed = error => ({
  type: types.API_V1_HGFHJF_LIST_FAILED,
  error
})
export const api_v1_hgfhjf_create = () => ({ type: types.API_V1_HGFHJF_CREATE })
export const api_v1_hgfhjf_createSucceeded = response => ({
  type: types.API_V1_HGFHJF_CREATE_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_createFailed = error => ({
  type: types.API_V1_HGFHJF_CREATE_FAILED,
  error
})
export const api_v1_hgfhjf_read = () => ({ type: types.API_V1_HGFHJF_READ })
export const api_v1_hgfhjf_readSucceeded = response => ({
  type: types.API_V1_HGFHJF_READ_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_readFailed = error => ({
  type: types.API_V1_HGFHJF_READ_FAILED,
  error
})
export const api_v1_hgfhjf_update = () => ({ type: types.API_V1_HGFHJF_UPDATE })
export const api_v1_hgfhjf_updateSucceeded = response => ({
  type: types.API_V1_HGFHJF_UPDATE_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_updateFailed = error => ({
  type: types.API_V1_HGFHJF_UPDATE_FAILED,
  error
})
export const api_v1_hgfhjf_partial_update = () => ({
  type: types.API_V1_HGFHJF_PARTIAL_UPDATE
})
export const api_v1_hgfhjf_partial_updateSucceeded = response => ({
  type: types.API_V1_HGFHJF_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_partial_updateFailed = error => ({
  type: types.API_V1_HGFHJF_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_hgfhjf_delete = () => ({ type: types.API_V1_HGFHJF_DELETE })
export const api_v1_hgfhjf_deleteSucceeded = response => ({
  type: types.API_V1_HGFHJF_DELETE_SUCCEEDED,
  response
})
export const api_v1_hgfhjf_deleteFailed = error => ({
  type: types.API_V1_HGFHJF_DELETE_FAILED,
  error
})
