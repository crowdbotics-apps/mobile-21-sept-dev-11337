...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HGFHJF_LIST:
    case types.API_V1_HGFHJF_LIST_SUCCEEDED:
    case types.API_V1_HGFHJF_LIST_FAILED:
    case types.API_V1_HGFHJF_CREATE:
    case types.API_V1_HGFHJF_CREATE_SUCCEEDED:
    case types.API_V1_HGFHJF_CREATE_FAILED:
    case types.API_V1_HGFHJF_READ:
    case types.API_V1_HGFHJF_READ_SUCCEEDED:
    case types.API_V1_HGFHJF_READ_FAILED:
    case types.API_V1_HGFHJF_UPDATE:
    case types.API_V1_HGFHJF_UPDATE_SUCCEEDED:
    case types.API_V1_HGFHJF_UPDATE_FAILED:
    case types.API_V1_HGFHJF_PARTIAL_UPDATE:
    case types.API_V1_HGFHJF_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HGFHJF_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HGFHJF_DELETE:
    case types.API_V1_HGFHJF_DELETE_SUCCEEDED:
    case types.API_V1_HGFHJF_DELETE_FAILED:
