...
function* api_v1_hgfhjf_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_list, action)
    yield put(actions.api_v1_hgfhjf_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_listFailed(err))
  }
}
function* api_v1_hgfhjf_listWatcher() {
  yield takeEvery(types.API_V1_HGFHJF_LIST, api_v1_hgfhjf_listWorker)
}
function* api_v1_hgfhjf_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_create, action)
    yield put(actions.api_v1_hgfhjf_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_createFailed(err))
  }
}
function* api_v1_hgfhjf_createWatcher() {
  yield takeEvery(types.API_V1_HGFHJF_CREATE, api_v1_hgfhjf_createWorker)
}
function* api_v1_hgfhjf_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_read, action)
    yield put(actions.api_v1_hgfhjf_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_readFailed(err))
  }
}
function* api_v1_hgfhjf_readWatcher() {
  yield takeEvery(types.API_V1_HGFHJF_READ, api_v1_hgfhjf_readWorker)
}
function* api_v1_hgfhjf_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_update, action)
    yield put(actions.api_v1_hgfhjf_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_updateFailed(err))
  }
}
function* api_v1_hgfhjf_updateWatcher() {
  yield takeEvery(types.API_V1_HGFHJF_UPDATE, api_v1_hgfhjf_updateWorker)
}
function* api_v1_hgfhjf_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_partial_update, action)
    yield put(actions.api_v1_hgfhjf_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_partial_updateFailed(err))
  }
}
function* api_v1_hgfhjf_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_HGFHJF_PARTIAL_UPDATE,
    api_v1_hgfhjf_partial_updateWorker
  )
}
function* api_v1_hgfhjf_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hgfhjf_delete, action)
    yield put(actions.api_v1_hgfhjf_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hgfhjf_deleteFailed(err))
  }
}
function* api_v1_hgfhjf_deleteWatcher() {
  yield takeEvery(types.API_V1_HGFHJF_DELETE, api_v1_hgfhjf_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_hgfhjf_listWatcher,
    api_v1_hgfhjf_createWatcher,
    api_v1_hgfhjf_readWatcher,
    api_v1_hgfhjf_updateWatcher,
    api_v1_hgfhjf_partial_updateWatcher,
    api_v1_hgfhjf_deleteWatcher,
